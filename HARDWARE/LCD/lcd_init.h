...
#define LCD_MOSI_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_3)//SDA=MOSI
#define LCD_MOSI_Set() GPIO_SetBits(GPIOA,GPIO_Pin_3)
...
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOA,GPIO_Pin_7)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOA,GPIO_Pin_7)
